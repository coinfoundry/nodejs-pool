...
function Coin(data){
    ...
    this.convertBlob = function(blobBuffer, port){
        return cnUtil.convert_blob(blobBuffer, 0);
    };

    this.constructNewBlob = function(blockTemplate, NonceBuffer, port){
        return cnUtil.construct_block_blob(blockTemplate, NonceBuffer, 0);
    };
    ...
    this.cryptoNight = function(convertedBlob, blockTemplate) {
	    ...
	    case 13007: return multiHashing.cryptonight_pico(convertedBlob, 0);						// Iridium
            ...
            case 18081: 
            case 7001: 
                return blockTemplate.buffer[0] >= 12 ? multiHashing.randomx(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 0) :
